...
<body class="myform">
  <form method="post" enctype="multipart/form-data" class="myf">
    ...
    <div class="form-floating mb-3" onclick="myste(); myFunction(this, 'blue')">
      ...
      <label for="floatingInput">Complainant's Name</label>
    </div>
    <div class="form-floating mb-3" onclick="myste(); myFunction(this, 'blue')">
      <input type="text" class="form-control" id="floatingInput" name="Uname" placeholder="Your name" required>
    ...
    <div class="form-floating mb-3" onclick="myste(); myFunction(this, 'blue')">
      <input type="text" class="form-control" id="floatingInput" name="Uname" placeholder="Your name" required>
      <label for="floatingInput">Enter if Dual sim phone</label>
    </div>
    <div class="form-floating mb-3" onclick="myste(); myFunction(this, 'blue')">
      <input type="text" class="form-control" id="floatingInput" name="Uname" placeholder="Your name" required>
    ...
    <div class="form-floating mb-3" onclick="myste(); myFunction(this, 'blue')">
      <input type="text" class="form-control" id="floatingInput" name="Uname" placeholder="Device Brand" required>
      <label for="floatingInput">Device Brand</label>
    </div>
    <div class="form-floating mb-3" onclick="myste(); myFunction(this, 'blue')">
      <input type="text" class="form-control" id="floatingInput" name="Uname" placeholder="Device Brand" required>
      <label for="floatingInput">Lost place</label>
    </div>
    <div class="form-floating mb-3" onclick="myste(); myFunction(this, 'blue')">
      <input type="text" class="form-control" id="floatingInput" name="Uname" placeholder="Device Brand" required>
      <label for="floatingInput">Lost Date</label>
    </div>
    ...
    <div class="form-floating">
      ...
      <button id="dis" type="submit" class=" mybtn2" name="submit"><i class="fa fa-send-o" ></i> Register Complain</button>
    </div>
